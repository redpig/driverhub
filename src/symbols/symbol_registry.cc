...
int __dev_change_net_namespace(void);
int __dev_fwnode(void);
int __dev_get_by_index(void);
int __dev_get_by_name(void);
int __dev_queue_xmit(void);
int __devm_alloc_percpu(void);
int __ethtool_get_link_ksettings(void);
int __fdget(void);
...
int alloc_netdev_mqs(void);
int alloc_pages_exact(void);
int alloc_skb_with_frags(void);
...
int dev_add_pack(void);
int dev_addr_add(void);
int dev_addr_del(void);
int dev_addr_mod(void);
...
int dst_release(void);
int efi(void);
int eth_header_parse(void);
int eth_mac_addr(void);
int eth_platform_get_mac_address(void);
int eth_type_trans(void);
int eth_validate_addr(void);
int ether_setup(void);
int ethtool_convert_legacy_u32_to_link_mode(void);
int ethtool_convert_link_mode_to_legacy_u32(void);
int ethtool_op_get_link(void);
int ethtool_op_get_ts_info(void);
...
int genl_register_family(void);
int genl_unregister_family(void);
int genlmsg_put(void);
...
int kfree_skb_list_reason(void);
int kfree_skb_partial(void);
int kfree_skb_reason(void);
int kill_fasync(void);
int kimage_voffset(void);
int kmalloc_large(void);
int kmalloc_large_node(void);
int kmalloc_node_trace(void);
int kmem_cache_alloc(void);
int kmem_cache_create(void);
int kmem_cache_create_usercopy(void);
int kmem_cache_destroy(void);
int kmem_cache_free(void);
...
int napi_complete_done(void);
int napi_disable(void);
int napi_enable(void);
int napi_gro_receive(void);
int napi_schedule_prep(void);
int nd_tbl(void);
...
int netdev_err(void);
int netdev_info(void);
int netdev_name_in_use(void);
int netdev_notice(void);
int netdev_printk(void);
int netdev_rx_handler_register(void);
int netdev_rx_handler_unregister(void);
int netdev_update_features(void);
int netdev_upper_dev_link(void);
int netdev_upper_dev_unlink(void);
int netdev_warn(void);
int netif_carrier_off(void);
int netif_carrier_on(void);
int netif_device_attach(void);
int netif_device_detach(void);
int netif_inherit_tso_max(void);
int netif_napi_add_weight(void);
int netif_receive_skb(void);
int netif_rx(void);
int netif_set_tso_max_size(void);
int netif_stacked_transfer_operstate(void);
int netif_tx_lock(void);
int netif_tx_unlock(void);
int netif_tx_wake_queue(void);
int netlink_broadcast(void);
int netlink_capable(void);
int netlink_net_capable(void);
int netlink_register_notifier(void);
int netlink_unicast(void);
...
int nla_memcpy(void);
int nla_put(void);
int nla_put_64bit(void);
int nla_strscpy(void);
...
int proto_register(void);
int proto_unregister(void);
...
int register_netdevice_notifier(void);
int register_oom_notifier(void);
int register_pernet_device(void);
int register_pernet_subsys(void);
...
int rtnl_link_register(void);
int rtnl_link_unregister(void);
int rtnl_lock(void);
int rtnl_register_module(void);
int rtnl_unlock(void);
...
int skb_copy_datagram_iter(void);
int skb_copy_expand(void);
int skb_copy_header(void);
int skb_cow_data(void);
int skb_dequeue(void);
...
int skb_queue_purge_reason(void);
int skb_queue_tail(void);
...
int sock_i_ino(void);
int sock_i_uid(void);
int sock_init_data(void);
int sock_no_accept(void);
int sock_no_bind(void);
int sock_no_connect(void);
int sock_no_getname(void);
int sock_no_ioctl(void);
int sock_no_listen(void);
int sock_no_mmap(void);
int sock_no_recvmsg(void);
int sock_no_sendmsg(void);
int sock_no_shutdown(void);
int sock_no_socketpair(void);
int sock_queue_rcv_skb_reason(void);
int sock_recv_errqueue(void);
int sock_recvmsg(void);
int sock_register(void);
int sock_release(void);
int sock_rfree(void);
int sock_unregister(void);
...
int unregister_netdevice_many(void);
int unregister_netdevice_notifier(void);
int unregister_netdevice_queue(void);
int unregister_oom_notifier(void);
int unregister_pernet_device(void);
int unregister_pernet_subsys(void);
